...
const PluginfilecoverTwoPage = () => {
  return (
    <>
      <div className="bg-black-900_01 flex flex-col font-poppins items-center justify-end mx-auto pt-[62px] md:px-10 sm:px-5 px-[62px] w-full">
        <div className="flex flex-col gap-[42px] items-center justify-start max-w-[1440px] mx-auto w-full">
          <Img
            className="h-[120px] sm:h-auto object-cover w-[416px] md:w-full"
            src="images/img_frame6removebgpreview_120x416.png"
            alt="frame6removebgp"
          />
          <div className="flex flex-col items-center justify-start shadow-bs1 w-full">
            <div className="bg-black-900 h-[750px] relative w-full">
              <Img
              ...
              <div className="absolute sm:h-[100px] h-[101px] md:h-[451px] inset-x-[0] mx-auto top-[0] w-full">
                <div className="bg-black-900_05 border-b border-blue_gray-100_72 border-solid h-[100px] m-auto w-full"></div>
                <div className="absolute flex md:flex-col flex-row md:gap-5 h-max inset-[0] items-center justify-center m-auto w-4/5">
                  ...
                  <Img
                    className="h-4 md:ml-[0] ml-[366px] rounded-[1px]"
                  ...
                  <Text
                    className="md:ml-[0] ml-[50px] text-base text-gray-200"
                  ...
                  />
                  <Img
                    className="h-[18px] md:ml-[0] ml-[100px] w-[18px]"
                    src="images/img_search.svg"
                    alt="search"
                  />
                  <Img
                    className="h-[18px] md:ml-[0] ml-[30px] w-[18px]"
            ...
            <div className="bg-black-900 flex flex-col gap-[19px] items-center justify-end pt-[51px] w-full">
              ...
              <div className="flex flex-col md:gap-10 gap-[1920px] items-center justify-start w-full">
                <div className="sm:h-[1091px] md:h-[18187px] h-[269px] relative w-full">
                  <List
                    className="flex flex-col gap-[273px] items-center m-auto w-full"
                    orientation="vertical"
                  >
                    <div className="flex flex-1 md:flex-col flex-row md:gap-10 items-start justify-between my-0 overflow-auto pt-[22px] w-full">
                      <MainpageMoviecard
                        className="flex md:flex-1 flex-col items-center justify-end rounded-md w-[19%] md:w-full"
                      ...
                      />
                      <MainpageMoviecard
                        className="flex md:flex-1 flex-col font-roboto items-center justify-end rounded-md w-[19%] md:w-full"
                    ...
                    <div className="flex flex-1 md:flex-col flex-row md:gap-10 items-start justify-between my-0 overflow-auto pt-[22px] w-full">
                      <div className="h-[396px] relative w-[19%] md:w-full">
                        <MainpageMoviecard
                  ...
                  <div className="absolute bottom-[0] flex flex-row gap-2.5 items-center justify-center left-[10%] w-[9%]">
                    <Img
                      className="h-3.5 rounded-[1px] w-3.5"
                      src="images/img_user.svg"
                      alt="user_Two"
                  ...
                  <div className="absolute bottom-[0] flex flex-row gap-2.5 items-center justify-center left-[10%] w-[7%]">
                    <Img
                      className="h-3.5 rounded-[1px] w-3.5"
                      src="images/img_user.svg"
                      alt="user_Three"
                  ...
                  <div className="absolute bottom-[0] flex flex-row gap-2.5 items-center justify-center left-[10%] w-[10%]">
                    <Img
                      className="h-3.5 rounded-[1px] w-3.5"
                      src="images/img_user.svg"
                      alt="user_Four"
                  ...
                  <div className="absolute bottom-[0] flex flex-col items-center justify-start right-[0] w-[9%]">
                    <div className="bg-gradient2  flex flex-col items-end justify-end p-4 w-full">
                      <div className="flex flex-col h-10 items-center justify-start mb-[13px] mt-[162px] p-2 w-10">
                        <Img
                          className="h-6 w-6"
                          src="images/img_iconchevronright_white_a700.svg"
                          alt="iconchevronrigh"
                  ...
                  <div className="absolute bottom-[0] flex flex-col items-center justify-start left-[0] w-[9%]">
                    <div className="bg-gradient1  flex flex-col items-start justify-end p-[15px] w-full">
                      <div className="flex flex-col h-10 items-center justify-start mb-3.5 mt-[163px] p-2 rotate-[-180deg] w-10">
                        <Img
                          className="h-6 w-6"
                          src="images/img_iconchevronright.svg"
                          alt="iconchevronrigh_One"
                ...
                <div className="flex flex-col justify-start w-full">
                  ...
                  <Text
                    className="md:ml-[0] ml-[799px] mt-[1972px] text-sm text-white-A700"
                    size="txtInterSemiBold14"
                  >
                    Pages
                  </Text>
                  <Text
                    className="md:ml-[0] ml-[1014px] mt-[1972px] text-sm text-white-A700"
                    size="txtInterSemiBold14"
                  >
                    Our social networks
                  </Text>
                  <Text
                    className="md:ml-[0] ml-[1199px] mt-[1972px] text-sm text-white-A700"
                    size="txtInterSemiBold14"
                  >
                    For reference
                  </Text>
                  <div className="flex flex-col items-center justify-end md:ml-[0] ml-[149px] mt-[1979px] w-[9%] md:w-full">
                    <Img
                      className="h-[39px] md:h-auto object-cover w-full"
                      src="images/img_frame6removebgpreview_39x125.png"
                      alt="frame6removebgp_Two"
                    />
                  </div>
                  <Text
                    className="md:ml-[0] ml-[795px] mt-[2004px] text-white-A700 text-xs"
                    size="txtInterMedium12"
                  >
                    The most watched movies
                  </Text>
                  <Text
                    className="md:ml-[0] ml-[1010px] mt-[2004px] text-white-A700 text-xs"
                    size="txtInterMedium12"
                  >
                    Telegram
                  </Text>
                  <Text
                    className="md:ml-[0] ml-[1195px] mt-[2004px] text-white-A700 text-xs"
                    size="txtInterMedium12"
                  >
                    Telegram
                  </Text>
                  <Text
                    className="md:ml-[0] ml-[795px] mt-[2026px] text-white-A700 text-xs"
                    size="txtInterMedium12"
                  >
                    Top Rated Movies
                  </Text>
                  <Text
                    className="md:ml-[0] ml-[1010px] mt-[2026px] text-white-A700 text-xs"
                    size="txtInterMedium12"
                  >
                    Instagram
                  </Text>
                  <Text
                    className="md:ml-[0] ml-[1195px] mt-[2026px] text-white-A700 text-xs"
                    size="txtInterMedium12"
                  >
                    Instagram
                  </Text>
                  <Text
                    className="md:ml-[0] ml-[149px] mt-[2034px] text-white-A700 text-xs"
                    size="txtInterMedium12"
                  >
                    <>
                  ...
                  <Text
                    className="md:ml-[0] ml-[795px] mt-[2048px] text-white-A700 text-xs"
                    size="txtInterMedium12"
                  >
                    Movies
                  </Text>
                  <Text
                    className="md:ml-[0] ml-[1010px] mt-[2048px] text-white-A700 text-xs"
                    size="txtInterMedium12"
                  >
                    Facebook
                  </Text>
                  <Text
                    className="md:ml-[0] ml-[1195px] mt-[2048px] text-white-A700 text-xs"
                    size="txtInterMedium12"
                  >
                    Whatsapp
                  </Text>
                  <Text
                    className="md:ml-[0] ml-[795px] mt-[2070px] text-white-A700 text-xs"
                    size="txtInterMedium12"
                  >
                    Serials
                  </Text>
                  <Text
                    className="md:ml-[0] ml-[1010px] mt-[2070px] text-white-A700 text-xs"
                    size="txtInterMedium12"
                  >
                    YouTube
                  </Text>
                  <Text
                    className="md:ml-[0] ml-[1195px] mt-[2070px] text-white-A700 text-xs"
                    size="txtInterMedium12"
                  >
                    Skype
                  </Text>
                  <Text
                    className="md:ml-[0] ml-[636px] mt-[2241px] text-sm text-white-A700"
                    size="txtPoppinsMedium14WhiteA700"
                  >
                    <>
                      © Filmberry.com - 2023
...
export default PluginfilecoverTwoPage;
